# Reused verbatim from I. M. Viola, bem-fem-fsi (https://github.com/ignaziomviola/bem-fem-fsi),
# file vent_section.py, MIT License, Copyright (c) 2026 Ignazio Maria Viola. The module imports
# only numpy and is the closed-form sectional reference of the cavity model: Acosta (1955) and
# Tulin (1953) cavity solutions, the fits of Harwood, Young & Ceccio (2016), the re-entrant-jet
# stability criterion and the semi-theoretical washout boundary. Not modified here.
